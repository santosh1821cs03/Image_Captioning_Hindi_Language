...
def load_coco_data(data_path='./data', split='train'):
    ...
    #Replacing filename to use resnet features
    if split=='train':
        data['features'] = hickle.load(os.path.join('/home1/santosh/Gaurav_Work/show-attend-and-tell/data/train_hindi', 'train_hindi.features_resnet101.hkl' ))
    else:
        data['features']=   hickle.load(os.path.join('/home1/santosh/Gaurav_Work/show-attend-and-tell/data/val', 'val.features_resnet101.hkl' ))
    ...
    if split == 'train' or split=='train_hindi':       
